					...
					<div class='upper'>
						...
						<div class='h_mid clearFix'>
							...
							<div class='login_h fr clearFix'>
								<p class='manage fl clearFix'>
									...
									<a href="personalData.php" class='mar_left fl'>设置</a>
									<?php if($_SESSION['undertype'] == 1):?>
									<i class='fl ver_bar'>|</i>
									<a href="../admin/adminLogin.php" class='mar_left fl'>管理中心</a>
									<?php endif;?>
									<i class='fl ver_bar'>|</i>
									<a href="loginOut.php" class='mar_left fl'>
										退出
									</a>
									<br />
							...
							<div class='login fr clearFix'>
								...
								<div class="g_pass fl">
									<a href='./getpass.php' class="gp_up">找回密码</a>
									<a href='./register.php' class="gp_down">
									立即注册</a>
								</div>
							</div>
							<?php endif;?>							
						...
						<div class="h_bot">
							...
							<div class='hb_down clearFix'>
								...
								<div class="fl">
									<form action="search.php" method="post" enctype="multipart/form-data" class="clearFix">
